...
describe("bothArr", () => {
    ...
    it("that takes in two arrays as arguments and returns one array with no duplicate values", () => {
      ...
      //an expect method, nested within the test block, calling on the hello() function, followed by the .toEqual() matcher that checks the expected output of the function return.
      expect(bothArr(testArray1,testArray2)).toEqual([3, 7, 10, 5, 4, 8, 2, 1])
    })
  })
...
//make const that combines both arrays
//and then returns a new set of the arrays
// without duplicate numbers names bothArr
// could not get the test to pass on either code
